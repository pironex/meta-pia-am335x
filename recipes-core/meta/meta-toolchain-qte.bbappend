toolchain_create_sdk_env_script_append() {
	...
	echo 'export QMAKE_DEFAULT_LIBDIRS=${OE_QMAKE_LIBDIR_QT}' >> $script
	echo 'export QMAKE_DEFAULT_INCDIRS=${OE_QMAKE_INCDIR_QT}' >> $script
	...
	(cd ${SDK_OUTPUT}/${SDKTARGETSYSROOT}/usr; ln -s ${SDKTARGETSYSROOT}/usr/share/${QT_DIR_NAME}/mkspecs mkspecs;)
}
